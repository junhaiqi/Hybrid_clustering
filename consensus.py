...
if __name__ == '__main__':
    ...
    if not os.path.exists('Consensus_Outputs/'):
        os.makedirs('Consensus_Outputs/')
    ...
    with open(f'{path}Consensus_Outputs/{out_file_prefix}_consensus.fasta', 'w', newline='') as f:
    ...
    #print(f'Wrote summary of output to: Outputs/{out_file_prefix}_consensus.fasta')
