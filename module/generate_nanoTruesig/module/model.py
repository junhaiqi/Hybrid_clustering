...
#     filter_freq=850
#     noise_std=1.5
def sequence_to_true_signal(input_part, kmer_poremodel='null', perfect=1, p_len=1,
    repeat_alpha=0.1, repeat_more=1, event_std=1.0, filter_freq=850, noise_std=1.5,
    sigroot='signal', seed=0,sigout=False):
    #--- unzip input args ---#
...
if __name__ == '__main__':
    ...
    #parser.add_argument('-l', action='store', dest='alignment', required=True, help='prefix the alignment file')
    ...
    parser.add_argument('--sigout', action='store', dest='sigout',
        ...
        default=False)
    #parser.add_argument('-F', action='store', dest='fast5_root', required=True, help='The fast5 file root')
    #parser.add_argument('-T', action='store', dest='fast5_template', required=True,help='The fast5 file template')
